...
namespace BW.GameCode.Pathing
{
    ...
    public class PathMash {
        ...
        public PathMash(Dictionary<Vector3Int, PathNode> nodeDict) {
        ...
        public List<PathNode> GetNeighbour(PathNode point, bool allowDiagonal = true) {
            ...
            IEnumerable<Vector3Int> neighbourCoordinates = center.GetNeightbours(allowDiagonal);
